...
class DjbcDocs(models.Model):
    ...
    jenis_dok = fields.Many2one("djbc.doctype", string="Doc Type", required=True)
    no_aju = fields.Char(string="Nomor Pengajuan")
    ...
    nm_cargoowner = fields.Many2one("res.partner", string="Nama Cargo Owner")
    ...
    document_state = fields.Char(string='Document Status')
    id_platform = fields.Char(string='Id Platform', default='XXXXX')
    terminal = fields.Many2one("res.partner", string="Terminal")
    ...
    forwarder_name = fields.Many2one("res.partner", string="Nama FF/PPJK")
    id_ff_ppjk = fields.Char(string='NPWP FF/PPJK', related='forwarder_name.vat', readonly=False)
    shipping_name = fields.Many2one("res.partner", string="Shipping Name")
